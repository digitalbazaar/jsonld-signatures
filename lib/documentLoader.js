 ...
 * from an in-memory, immutable copy of the context document to ensure content integrity.
...
api.strictDocumentLoader = api.extendContextLoader(url => {
   ...
   * calls are made and all contexts are available locally.
   ...
   * url is not in the context map (i.e., not a URL for a locally available context document).
   * @return {Object} A JSON-LD RemoteDocument that is a copy of a locally available context.
   */
