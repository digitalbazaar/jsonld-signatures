...
module.exports = class LinkedDataSignature extends LinkedDataProof {
   ...
   */
  async createProof(
    {document, purpose, documentLoader, expansionMap, assumeSecurityContext}) {
  ...
  async canonize(input, {documentLoader, expansionMap, assumeSecurityContext}) {
  ...
  async canonizeProof(
    proof, {documentLoader, expansionMap, assumeSecurityContext}) {
   ...
   * @param expansionMap {function}
   */
  async getVerificationMethod({proof, documentLoader, expansionMap}) {
