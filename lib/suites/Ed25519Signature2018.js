...
module.exports = class Ed25519Signature2018 extends JwsLinkedDataSignature {
   ...
   * @param [useNative] {boolean} true to use a native canonize algorithm.
   */
  constructor(
    {signer, key, creator, verificationMethod, proof, date, useNative} = {}) {
    super({
      type: 'Ed25519Signature2018', alg: 'EdDSA', LDKeyClass: Ed25519KeyPair,
      creator, verificationMethod, signer, key, proof, date, useNative});
