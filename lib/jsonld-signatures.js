 ...
 *
 * @param {object|string} document - The document to be signed, either
 *   a string URL (resolved to an object via the given `documentLoader`) or a
 *   plain object (JSON-LD document).
 *
...
function _ensureSuiteContext({document, contextUrl, addSuiteContext}) {
  ...
  // document does contain the context, do nothing
}
